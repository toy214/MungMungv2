...
export const lessonsData = {
   ...
   "Lesson 3: Numbers": {
    sections: {
      "Introduction to Numbers": {
        text: [
          "Korean numbers have two systems: Native and Sino-Korean.",
          "Native numbers are typically used for counting items, people, and age.",
          "Sino-Korean numbers are used for dates, money, addresses, and phone numbers."
        ],
        korean: []
      },
      "Native Numbers": {
  ...
  "Lesson 4: Days and Time": {
    sections: {
      "Months": {
        text: [
          "Months are read using Sino-Korean numbers + 월 (month).",
          "January     1월          il-wol",
          "February    2월          i-wol",
          "March       3월          sam-wol",
          "April       4월          sa-wol",
      ...
      "Practice": {
        text: [
          "1. 지금 몇 시예요? (What time is it now?) Ji-geum myeot si-ye-yo?",
          "2. 지금 다섯 시 삼십 분이에요. (It’s 5:30 now.) Ji-geum da-seot si sam-sip bun-i-e-yo.",
          "3. 버스는 몇 시에 도착해요? (What time does the bus arrive?) Beo-seu-neun myeot si-e do-chak-hae-yo?",
          "4. 버스는 오후 네 시 오 분에 도착해요. (The bus arrives at 4:05 PM.) Beo-seu-neun o-hu ne si o bun-e do-chak-hae-yo."
        ],
        korean: ["지금 몇 시예요?", "지금 다섯 시 삼십 분이에요.", "버스는 몇 시에 도착해요?", "버스는 오후 네 시 오 분에 도착해요."]
      }
    }
  },
  "Lesson 5: Restaurant Phrases": {
    sections: {
      "Viewing the Menu": {
        text: [
          "메뉴 좀 볼 수 있을까요? (Menu jom bol su isseulkkayo?) - Can I see the menu, please? [me.nju dʑom bol su i.sɯl.k͈a.jo]",
          "뭐를 추천하시나요? (Mweoreul chucheonhashinayo?) - What do you recommend? [mwʌ.ɾɯl tɕʰu.tɕʰʌn.ha.ɕi.na.jo]",
          "오늘의 추천 요리가 있나요? (Oneureui chucheon yoriga innayo?) - Do you have any specials today? [o.nɯ.ɾe.ɰi tɕʰu.tɕʰʌn jo.ɾi.ga in.na.jo]"
        ],
        korean: [
          "메뉴 좀 볼 수 있을까요?",
          "뭐를 추천하시나요?",
      ...
      "Placing Orders": {
        text: [
          "김치찌개 주문할게요. (Kimchi jjigae jumunhalgeyo.) - I would like to order kimchi soup. [kim.tɕʰi tɕ͈i.gɛ dʑu.mun.hal.ge.jo]",
          "음료수 좀 주시겠어요? (Eumryosu jom jushigesseoyo?) - Can I get a drink? [ɯm.ɾjo.su dʑom dʑu.ɕi.gɛ.s͈ʌ.jo]",
          "불고기를 추가할 수 있을까요? (Bulgogireul chuga hal su isseulkkayo?) - Can we add bulgogi to our order? [pul.go.gi.ɾɯl tɕʰu.ga hal su i.sɯl.k͈a.jo]"
        ],
        korean: [
          "김치찌개 주문할게요.",
          "음료수 좀 주시겠어요?",
  ...
  "Lesson 6: At the Shopping Center": {
    sections: {
      "Shopping Phrases": {
        text: [
          "이거 얼마예요? (Igeo eolmayeyo?) - How much is this? [i.gʌ ʌl.ma.je.jo]",
          "좀 깎아주세요 (Jom kakkajuseyo) - Please give me a discount. [tɕom kak.kʰa.dʑu.se.jo]",
          "더 주세요 (Deo juseyo) - Please add more. [tʌ dʑu.se.jo]"
        ],
        korean: [
          "이거 얼마예요",
          "좀 깎아주세요",
