...
export const lessonsData = {
  ...
  "Lesson 8: Family and Relationships": {
    ...
    text: [
      ...
      "회색 (Hoe-saek) = Gray",
      "",
      "2. Learning Expressions to Describe Colors:",
      "이것은 빨간색이에요. (This is red.)",
      "I-geos-eun ppal-gan-saek-i-e-yo.",
      "",
      "그 차는 파란색이에요. (That car is blue.)",
      "Geu cha-neun pa-ran-saek-i-e-yo.",
      "",
      "저는 초록색을 좋아해요. (I like green.)",
      "Jeo-neun cho-rok-saek-eul jo-a-hae-yo.",
      "",
      "이 꽃은 노란색이에요. (This flower is yellow.)",
      "I kkot-eun no-ran-saek-i-e-yo.",
      "",
      "이 신발은 검정색이에요. (These shoes are black.)",
      "I sin-bal-eun geom-jeong-saek-i-e-yo.",
      "",
      "3. Questions and Answers Related to Colors:",
