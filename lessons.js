...
export const lessonsData = {
  ...
  "Lesson 8: Family and Relationships": {
    text: [
      "Common family terms:",
      "1. 아버지 (Abeoji) - Father. [a.bʌ.dʑi]",
      "2. 어머니 (Eomeoni) - Mother. [ʌ.mʌ.ni]",
      "3. 동생 (Dongsaeng) - Younger sibling. [toŋ.sɛŋ]",
      "4. 가족 (Gajok) - Family. [ka.dʑok]",
      "Relationships:",
      "여자 직원 (Yeoja jigwon) - Female employee. [jʌ.dʑa dʑi.gwʌn]",
      "학생 (Haksaeng) - Student. [hak.sɛŋ]",
      "어른 (Eoreun) - Elder. [ʌ.ɾɯn]"
    ],
    korean: [
      "",
      "아버지",
  ...
  "Lesson 9: Colors and Adjectives": {
    text: [
      "Colors:",
      "빨간색 (Ppalgansek) - Red. [p͈al.gan.sɛk]",
      "갈색 (Galsaek) - Brown. [kal.sɛk]",
      "파란색 (Paransaek) - Blue. [pʰa.ɾan.sɛk]",
      "Adjectives:",
      "아름답다 (Areumdapda) - Beautiful. [a.ɾɯm.dap.da]",
      "빠르다 (Ppareuda) - Fast. [p͈a.ɾɯ.da]",
      "Examples:",
      "아름다워 보여요 (Areumdaweo boyeoyo) - It looks beautiful. [a.ɾɯm.da.wʌ bo.jʌ.jo]",
      "빨리 걸으세요 (Ppalli georeuseyo) - Walk fast. [p͈al.li kʌ.ɾɯ.se.jo]"
    ],
    korean: [
      "",
      "빨간색",
